...
let s:lemma =		"\\begin{lemma}\\label{" . s:labelprefix_lemma . "<+label+>}\<cr><++>\<cr>\\end{lemma}" . s:end_with_cr . "<++>"
let s:corollary =	"\\begin{corollary}\\label{" . s:labelprefix_corollary . "<+label+>}\<cr><++>\<cr>\\end{corollary}" . s:end_with_cr . "<++>"
let s:conjecture =	"\\begin{conjecture}\\label{" . s:labelprefix_conjecture . "<+label+>}\<cr><++>\<cr>\\end{conjecture}" . s:end_with_cr . "<++>"
