...
let s:labelprefix_proposition = Tex_GetVarValue("Tex_EnvLabelprefix_{'proposition'}")
let s:labelprefix_lemma = Tex_GetVarValue("Tex_EnvLabelprefix_{'lemma'}")
let s:labelprefix_conjecture = Tex_GetVarValue("Tex_EnvLabelprefix_{'conjecture'}")
let s:labelprefix_corollary = Tex_GetVarValue("Tex_EnvLabelprefix_{'corollary'}")
...
let s:Bsmallmatrix =	"\\begin{Bsmallmatrix} <++> \\end{Bsmallmatrix}<++>"
let s:matrix =		"\\begin{matrix}\<cr><++>\<cr>\\end{matrix}<++>"
let s:pmatrix =		"\\begin{pmatrix}\<cr><++>\<cr>\\end{pmatrix}<++>"
let s:bmatrix =		"\\begin{bmatrix}\<cr><++>\<cr>\\end{bmatrix}<++>"
let s:Bmatrix =		"\\begin{Bmatrix}\<cr><++>\<cr>\\end{Bmatrix}<++>"
...
let s:example =		"\\begin{example}\<cr>\\label{" . s:labelprefix_example . "<+label+>}\<cr><++>\<cr>\\end{example}" . s:end_with_cr . "<++>"
let s:exercise =	"\\begin{exercise}\<cr>\\label{" . s:labelprefix_example . "<+label+>}\<cr><++>\<cr>\\end{exercise}" . s:end_with_cr . "<++>"
let s:method =		"\\begin{method}\<cr>\\label{" . s:labelprefix_method . "<+label+>}\<cr><++>\<cr>\\end{method}" . s:end_with_cr . "<++>"
let s:axiom =		"\\begin{axiom}\<cr>\\label{" . s:labelprefix_axiom . "<+label+>}\<cr><++>\<cr>\\end{axiom}" . s:end_with_cr . "<++>"
" }}}
